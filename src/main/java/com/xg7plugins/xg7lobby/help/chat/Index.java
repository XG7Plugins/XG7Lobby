...
public class Index implements HelpChatPage {
    ...
    public List<Text> getComponents(CommandSender sender) {
        ...
        components.add(
                TextComponentBuilder.of(Text.fromLang(sender, XG7LobbyLoader.getInstance(), "help-in-chat.about").join().getText())
        ...
        components.add(Text.format(" "));
        components.add(TextComponentBuilder.of(Text.fromLang(sender, XG7LobbyLoader.getInstance(), "help-in-chat.lang").join().getText())
                .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND, "/xg7plugins lang"))
                .build());
        components.add(TextComponentBuilder.of(Text.fromLang(sender, XG7LobbyLoader.getInstance(), "help-in-chat.tasks").join().getText())
                .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND, "/xg7lobby help selector-guide"))
                .build());
        components.add(TextComponentBuilder.of(Text.fromLang(sender, XG7LobbyLoader.getInstance(), "help-in-chat.commands").join().getText())
                .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND, "/xg7lobby help command-page1"))
                .build());
        components.add(TextComponentBuilder.of(Text.fromLang(sender, XG7LobbyLoader.getInstance(), "help-in-chat.menus-guide").join().getText())

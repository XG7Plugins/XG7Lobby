    ...
    public HologramLine toHologramLine() {
        ...
        switch (type) {
            ...
            case DISPLAY:
                ...
                float[] scale = options.get("scale") != null ? (float[]) options.get("scale") : new float[]{1.0f, 1.0f, 1.0f};
                ...
                Color backgroundColor = options.get("backgroundColor") != null ? Color.decode(options.get("backgroundColor").toString()) : Color.BLACK;
                boolean shadow = options.get("shadow") != null ? (Boolean) options.get("shadow") : true;
                boolean seeThrough = options.get("seeThrough") != null ? (Boolean) options.get("seeThrough") : false;
                TextDisplayLine.Billboard billboard = options.get("billboard") != null ? TextDisplayLine.Billboard.valueOf(options.get("billboard").toString().toUpperCase()) : TextDisplayLine.Billboard.FIXED;
                TextDisplayLine.Alignment alignment = options.get("alignment") != null ? TextDisplayLine.Alignment.valueOf(options.get("alignment").toString().toUpperCase()) : TextDisplayLine.Alignment.CENTER;
